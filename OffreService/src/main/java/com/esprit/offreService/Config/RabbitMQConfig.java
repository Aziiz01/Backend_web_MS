package com.esprit.offreService.Config;
...
public class RabbitMQConfig {
    ...
    public static final String QUEUE_NAME = "offre.queue";
    public static final String EXCHANGE_NAME = "offre.exchange";
    public static final String ROUTING_KEY = "offre.routingkey";
