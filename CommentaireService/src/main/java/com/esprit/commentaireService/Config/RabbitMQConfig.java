...
public class RabbitMQConfig {
    ...
    public static final String QUEUE_NAME = "commentaire.queue";
    public static final String EXCHANGE_NAME = "commentaire.exchange";
    public static final String ROUTING_KEY = "commentaire.routingkey";
